								...
								<Form action="#" className="space-y-4 md:space-y-6">
									<div className='flex flex-row justify-between gap-[2.5em]'>
										<div className="w-1/2">
											...
											<Field
												...
												className="border text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 border-gray-600 placeholder-gray-400 text-white focus:border-blue-500"
											/>
										...
										<div className="w-1/2">
											...
											<Field
												...
												className="border text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5  border-gray-600 placeholder-gray-400 text-white focus:ring-border-500 focus:border-blue-500"
											/>
									...
									<div className='flex flex-row justify-between gap-[2.5em]'>
										...
										<div className="w-1/2">
											...
											<div className = "flex justify-between items-center p-2.5 rounded-lg space-x-1 border border-gray-600 placeholder-gray-400 text-white focus:ring-border-500 focus:border-blue-500">
												<Field
													id = "password"
													name="password"
									...
									<div className='flex gap-10 justify-center'>
										...
										<div className="flex justify-center gap-[3em] cursor-pointer">
											...
											<div className="flex items-center ">
												...
												<label htmlFor='bordered-1' className='w-full py-4 ms-2 text-sm font-medium text-gray-900'>Customer</label>
											</div>	
										</div>	
									</div>
